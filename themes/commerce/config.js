const CONFIG = {
  ...
  COMMERCE_TEXT_CENTER_TITLE: 'Our Collection', // 中间产品区块标题
  COMMERCE_TEXT_CENTER_DESCRIPTION:
    'The vision of Witty Birdy is to provide safe & healthy gear for feathered friends all around the world.', // 中间产品区块文字描述
  ...
  COMMERCE_TEXT_FOOTER_MENU_1: 'Our Collection', // COMMERCE主题页脚左侧菜单标题1
